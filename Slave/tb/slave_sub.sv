package slave_sub_pkg;
    ...
    class slave_sub extends uvm_subscriber #(slave_txn);
        `uvm_component_utils(slave_sub)
        ...
        function new (string name = "slave_sub", uvm_component parent = null);
        ...
        function void build_phase (uvm_phase phase);
            ...
            sub_txn = slave_txn::type_id::create("sub_txn");
        endfunction
